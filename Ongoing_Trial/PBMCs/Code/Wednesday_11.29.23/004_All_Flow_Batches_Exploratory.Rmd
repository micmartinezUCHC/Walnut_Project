---
title: "004_All_Flow_Batches_Exploratory.Rmd"
...
This code is very similar to `001_FlowData_Reformatted.Rmd` which contained the flow data for batches 2 and 3. This script will operate the same, but it will contain all 3 initial batches. 

```{r set working directory and load libraries}
setwd("/users/mikemartinez/Desktop/Walnut_Project/Ongoing_Trial/PBMCs/Data/Reformatted_Data/")
...
b1 <- read.csv("/users/mikemartinez/Desktop/Walnut_Project/Ongoing_Trial/PBMCs/Data/Original_Data_From_Core/Flow_Batch_1.csv", header = TRUE, sep = ",")
b1$Batch <- "1"
b2 <- read.csv("/Users/mikemartinez/Desktop/Walnut_Project/Ongoing_Trial/PBMCs/Data/Original_Data_From_Core/Flow_Batch_2.csv", header = TRUE, sep = ",")
b2$Batch <- "2"
b3 <- read.csv("/Users/mikemartinez/Desktop/Walnut_Project/Ongoing_Trial/PBMCs/Data/Original_Data_From_Core/Flow_Batch_3.csv", header = TRUE, sep = ",")
b3$Batch <- "3"
flow <- rbind(b1, b2)
flow <- rbind(flow, b3)
```
...
write.csv(liveSC, file = "Merged_1.2.3_All_Live_SingleCells.csv")
write.csv(flow1, file = "Merged_1.2.3_All_Flow_Data.csv")
```

We can isolate just the lymphocytes and their subcategories into separate data frames
```{r isolate lymphocyte markers}

setwd("/Users/mikemartinez/Desktop/Walnut_Project/Ongoing_Trial/PBMCs/Data/Reformatted_Data/Batches_1_2_3/Batch1_2_3_Lymphocytes/")
flow1 <- read.csv("/Users/mikemartinez/Desktop/Walnut_Project/Ongoing_Trial/PBMCs/Data/Reformatted_Data/Merged_1.2.3_All_Flow_Data.csv")
# All lymphocyte data
All_Lymphocytes <- flow1[grepl("Lymphocytes", flow1$Col2),]
write.csv(All_Lymphocytes, file = "Merged_1_2.3_All_Lymphocytes.csv")
...
write.csv(Overall_Lymphocytes, file = "Merged_1_2.3_Overall_Lymphocytes.csv")
...
write.csv(CD3_Lymphocytes, file = "Merged_1_2.3_CD3_Lymphocytes.csv")
...
write.csv(CD4_pos_Lymphocytes, file = "Merged_1_2.3_CD4_pos_CD8_neg_Lymphocytes.csv")
...
write.csv(Double_pos_Lymphocytes, file = "Merged_1_2.3_CD4_CD8_Double_pos_Lymphocytes.csv")
...
write.csv(CD8_pos_Lymphocytes, file = "Merged_1_2.3_CD8_pos_CD4_neg_Lymphocytes.csv")
...
write.csv(Double_neg_Lymphocytes, file = "Merged_1_2.3_CD4_CD8_Double_neg_Lymphocytes.csv")
...
write.csv(CD19_Lymphocytes, "Merged_1_2.3_CD19_Lymphocytes.csv")
...
write.csv(NK_Lymphocytes, "Merged_1_2.3_NK_Lymphocytes.csv")
...
write.csv(NKT_Lymphocytes, "Merged_1_2.3_NKT_Lymphocytes.csv")
...
write.csv(CD16_CD3_doubleNeg, "Merged_1_2.3_CD16_CD3_Double_neg_Lymphocytes.csv")
...
write.csv(T_Lymphocytes, "Merged_1_2.3_T_Lymphocytes.csv")
...
setwd("/Users/mikemartinez/Desktop/Walnut_Project/Ongoing_Trial/PBMCs/Data/Reformatted_Data/Batches_1_2_3/Batch1_2_3_Monocytes/")

# All monocytes data
All_Monocytes <- flow1[grepl("Monocytes", flow1$Col2),]
write.csv(All_Monocytes, file = "Merged_1_2.3_All_Monocytes.csv")
...
write.csv(Overall_Mono, file = "Merged_1_2.3_Overall_Monocytes.csv")
...
write.csv(CD64_Mono, file = "Merged_1_2.3_CD64_Monocytes.csv")
...
write.csv(Classical_Mono, file = "Merged_1_2.3_Classical_Monocytes.csv")
...
write.csv(int_Mono, file = "Merged_1_2.3_Int_Monocytes.csv")
...
write.csv(NC_Mono, file = "Merged_1_2.3_Nonclassical_Monocytes.csv")
...
write.csv(CD14_CD16_doubleNeg, file = "Merged_1_2.3_CD14_CD16_Double_Neg_Monocytes.csv")
```


Note: You need to manually go in and edit the names for batch 1 sample 1010. I don't know why, but it doesnt behave properly and it screws up things downstream otherwise in terms of the P-value generated because there is not a paired sample for 1010 (missing before). Add this information to your lab notebook when you get a chance